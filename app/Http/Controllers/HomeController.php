...
class HomeController extends Controller
{
  ...
  */
  public function index()
  {
    ...
    // $course_exam = CourseExam::findOrFail(1);
    // if (!$student->exams->contains($course_exam->id)) {
    //   $student->exams()->attach([$course_exam->id]);
    // }
    // Debugbar::info($student->exams);
    ...
    // return view('welcome', ['exams' =>  $student->exams]);
  }
}
